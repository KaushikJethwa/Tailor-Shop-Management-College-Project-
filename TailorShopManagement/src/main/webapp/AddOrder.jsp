  ...
  <main>
    <div class="row g-2">
        ...
        <div class=" col-lg-6 col-md-6  p-3">
            <form class="mt-3 border border p-5 bg-light" id="form" action="AddOrderServlet"
            method="post">
              ...
              <div class="form-floating mb-3">
                <input
                  ...
                  id="formId2"
                  placeholder="" required/>
                <label for="formId2">Contact</label>
              </div>
              <div class="form-floating mb-3">
                <input
                  type="text"
                  ...
                  id="formId3"
                  placeholder=""/ required>
                <label for="formId3">Address</label>
              </div>
              <div class="form-floating mb-3">
                <input
                  type="email"
