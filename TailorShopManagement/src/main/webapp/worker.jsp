...
<body>
    ...
    <main>
        ...
        List<WorkerDressOrderPOJO> dressUrgentOrders = dao.showUrgentDressOrders(username);
        List<WorkerBlouseOrderPOJO> blouseUrgentOrders = dao.showUrgentBlouseOrders(username);
        List<WorkerDressBlouseBothPOJO> dressblouseUrgentOrders = dao.showUrgentDressBlouseOrders(username);
        
        %>
        <div class="row mt-5">
            <% for (WorkerDressOrderPOJO dress : dressUrgentOrders) { %>
            <div class="col-md-4">
                <div class="card mb-4"  style="max-height:500px; max-width:400px; overflow:auto">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Status: Urgent</p>
            ...
            <% for (WorkerBlouseOrderPOJO blouse : blouseUrgentOrders) { %>
            <div class="col-md-4">
                <div class="card mb-4" style="max-height:500px; max-width:400px; overflow:auto">
            ...
            <% for (WorkerDressBlouseBothPOJO dressblouseboth : dressblouseUrgentOrders) { %>
            <div class="col-md-4">
                <div class="card mb-4" style="max-height:500px; max-width:400px; overflow:auto">
